...
export default function About() {
  return (
    <div data-testid="about-section"  className="p-8 lg:px-16 flex flex-col py-12 bg-white">
      <h2 className="text-2xl font-title">About</h2>
      <div data-testid="about-blurb" className="py-4 font-text">
        <p>
