...
export default function PosterHero(props: HeroProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-between h-screen w-[100vw] ">
            ...
            {nextGig !== undefined && 
              <Link data-testid="next-gig" href={'/#calendar'} className="border-2 border-blue-950 rounded mx-4 hover:cursor-pointer hover:text-blue-900 text-blue-900 font-announce text-2xl md:text-3xl  lg:mr-[18vw] self-end px-2">
