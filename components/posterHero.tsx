  ...
  return (
    <div className="flex flex-col items-center justify-between h-[100dvh] w-[100vw] ">
            ...
            <div className="flex flex-row ">
              <div className="font-title backdrop-blur-sm lg:ml-[16vw] text-blue-950  text-xl md:text-2xl px-2 font-bold  self-center">
          ...
          <Link data-testid="insta-link" href="https://www.instagram.com/thebigfirkinband/" target="_blank"  title="Firkin Band Instagram" className="flex flex-row items-center self-end mt-4">
            ...
            <div className="flex flex-col ">
              <Link data-testid="next-gig" href={'/#calendar'} className="border shadow border-blue-950 rounded mx-4 hover:cursor-pointer hover:text-blue-900 text-blue-900 font-announce text-2xl md:text-3xl  lg:mr-[10vw] self-end px-2">
