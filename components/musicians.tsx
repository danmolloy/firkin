...
export default function Musicians() {
  return (
    <div id="dark-section" data-testid="musicians-section" className="p-8 flex flex-col bg-black text-white">
      <h2 className="text-2xl font-title">Musicians</h2>
      <div data-testid="band-musicians " className="py-4 flex flex-col">
        <h3 className="text-xl pb-1 font-title">The Band</h3>
        <p>
        ...
        <Image data-testid={"band-img"} src={bandFront} width={500} alt="Placeholder for a band photo" title="Band photo placeholder" className="self-center py-4"/>
      </div>
      <div data-testid="band-leader" className="py-4 flex flex-col">
        <h3 className="text-xl pb-1 font-title">Eoghan Kelly</h3>
        <p>
